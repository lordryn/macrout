...
class MacroEvent:
    ...
    def from_dict(data):
        if data['type'] == 'click':
            # Legacy support for old "ClickEvent"
...
class MousePressEvent(MacroEvent):
    ...
    def execute(self):
        # We assume X/Y moves are instant for the press
...
class ClickEvent(MacroEvent):
    """Retained for manual 'Add Click' or legacy files, but Recorder will use Press/Release."""
